...
#had to rename "month" and "year" as "Month" and "Year"
...
O3plot2 <- ggplot(EPAair) +
  #geom_point(aes(x = Date, y = Ozone, color = "blue")) - cannot specify color in aesthetics()
...
tempvsdepth <- 
  ...
  geom_point() +
  scale_y_reverse() #makes sense visually because we are dealing with depth
print(tempvsdepth)
...
# issues: no legend, not all lines are for "tn_ug". inefficient code.
Nutrientplot6 <-
