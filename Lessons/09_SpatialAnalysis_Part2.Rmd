...
mapview(huc8_sf, col.regions = "orange") +
  mapview(huc8_sf.v2, col.regions = "purple")
...
huc8_wind <-
  ...
  group_by(HUC8) %>%
  dplyr::summarise(kWhkm2day = sum(kWhkm2day))
...
site_30km <-
  st_buffer(theSite_sfc_transformed, 30000)
mapview(site_30km)

resultMask_30km <-
  st_intersects(counties_sf_utm,
                site_30km,
                sparse = FALSE)

selCounties_30km <-
  counties_sf_utm[resultMask_30km,]
