...
> Answer: Console lets you know it attached packages
...
# ./ means current directory, ../ means go up one folder
...
> ANSWER: File is stored on USGS website. Columns have different data types so it would fit best in a dataframe. Seems like there are a lot of steps to pull the correct dataset... but it is stored in a universally accessible place which is good for reproducibility when pulling data.
