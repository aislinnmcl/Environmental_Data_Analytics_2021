...
```{r}
#Apply the API key
#census_api_key("cb94c37ef6437fa131964502a6e790a132f4c645", install = TRUE)
...
df <- data.frame(
  state = the_states,
  price_c_Mwh = the_price,
  capacity_Mwh = as.numeric(gsub(",", "", the_capacity)),
  net_generation_Mwh = net_generation,
  total_Mwh = total_retail) %>%
  mutate(year = 2019)
)
```
