...
library(tidyverse)
Name <- c("EPA", "LTER")
Data <- c("air pollution", "lake chemistry")
...
plot.nitrogen <-
    ggplot(nutrients.processed, aes(x = sampledate, y = tn_ug, color = lakename)) +
    geom_line() +
    labs(title = "Total Nitrogren by Lake", subtitle = "1991-1999")
print(plot.nitrogen)
...
plot.phosphorus <-
    ggplot(nutrients.processed, aes(x = sampledate, y = tp_ug, color = lakename)) +
    geom_line() +
    labs(title = "Total Phosphorus by Lake", subtitle = "1991-1999")
