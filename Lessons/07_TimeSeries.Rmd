...
wind_data_clean <- 
  wind_data %>% 
  mutate( AWND.clean = zoo::na.approx(AWND) ) # add the name of the package (zoo) if the function occurs in multiple packages. don't have to call library
...
#null hypothesis is that the data is stationary. if p<.05, reject null.
