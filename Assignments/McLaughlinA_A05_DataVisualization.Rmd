...
chemnutrients_PeterPaul_processed <- read.csv("./Data/Processed/NTL-LTER_Lake_Chemistry_Nutrients_PeterPaul_
                                              Processed.csv")

nutrients_PeterPaul_gathered <- read.csv("./Data/Processed/NTL-LTER_Lake_Nutrients_PeterPaulGathered_
                                         Processed.csv")
...
lm(formula = chemnutrients_PeterPaul_processed$po4 ~ chemnutrients_PeterPaul_
   processed$tp_ug)


phos_plot <- ggplot(chemnutrients_PeterPaul_processed, aes(x = tp_ug, y = po4, 
                                                           color = lakename)) +
  geom_point() +
...
box_temp <- ggplot(chemnutrients_PeterPaul_processed, aes(x = as.factor(month), 
                                                          y = temperature_C, 
                                                          color = lakename)) +
  geom_boxplot() + 
  labs(color = "Lake Name") +
...
box_tp <- ggplot(chemnutrients_PeterPaul_processed, aes(x = as.factor(month), 
                                                        y = tp_ug, 
                                                        color = lakename)) +
  geom_boxplot() + 
  labs(color = "Lake Name") +
...
box_tn <- ggplot(chemnutrients_PeterPaul_processed, aes(x = as.factor(month), 
                                                        y = tn_ug, 
                                                        color = lakename)) +
  geom_boxplot() + 
  labs(color = "Lake Name") +
