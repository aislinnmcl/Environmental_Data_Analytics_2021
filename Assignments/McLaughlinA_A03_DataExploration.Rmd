...
> Answer: The 6 most commonly studied species (in descending order) are: Honey Bee, Parasitic Wasp, Buff Tailed Bumblebee, Carniolan Honey Bee, Bumble Bee, Italian Honeybee. As I mentioned earlier, bees are important pollinators and we would want to know if neonicotinoids were adversely affecting populations and increasing their mortality.
...
> Answer: The two most common endpoints are NOEL and LOEL. I actually had to do a `sort(summary())` to figure that out because even after full screening the plot, my x-axis was so mushed together that I couldn't read the labels. NOEL is an acronym for "no-observable-effect-level" and indicates that the highest concentration did not produce effects significantly different from the responses for the control group. Used for terrestrial databases. LOEL is an acronym for "lowest-observable-effect-level" and indicates that the lowest dose produced effects that were significantly different from the responses for the control group.
>
