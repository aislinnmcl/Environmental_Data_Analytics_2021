...
ozone.conc.plot <-
  ...
  labs(x = "Year", y = "Daily Ozone Concentration (ppm)", title = "Ozone Concentrations Over Time", subtitle = "Garinger High School, NC (2010-2019)")
...
GaringerOzone.monthly.components.nonseas <-
  as.data.frame(GaringerOzone.monthly.decomp$time.series[,2:3])

GaringerOzone.monthly.components.nonseas <-
  mutate(GaringerOzone.monthly.components.nonseas, 
         Mean.Ozone = GaringerOzone.monthly$Mean_Ozone,
         Date = GaringerOzone.monthly$Date)

GaringerOzone.monthly.nonseas.ts <-
  ts(GaringerOzone.monthly.components.nonseas$Mean.Ozone, start = c(f_year, f_month), frequency = 12)
...
> Answer: After removing seasonality, our p-value = 0.34 which is greater than 0.05. We fail to reject the null hypothesis so we cannot conclude that there is a non-seasonal trend in the data.
