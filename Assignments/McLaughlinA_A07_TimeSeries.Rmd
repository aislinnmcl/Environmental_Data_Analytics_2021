...
GaringerOzone.monthly.nonseas.ts <-
  ts(GaringerOzone.monthly.components$Nonseasonal_Observed, start = c(f_year, f_month), frequency = 12)

GaringerOzone.monthly.nonseas.decomp <-
  stl(GaringerOzone.monthly.nonseas.ts, s.window = "periodic")
plot(GaringerOzone.monthly.nonseas.decomp)
