...
gages <- 
  read.csv("./Data/Raw/NWIS_SiteInfo_NE_RAW.csv")
...
>ANSWER: "dec_long_va" and "dec_lat_va" have been comined into a column called "geometry".
...
mapview(counties_sf_utm, col.regions = "NA", layer.name = "Counties") +
...
mapview(counties_sf, col.regions = "white", layer.name = "Counties") +
