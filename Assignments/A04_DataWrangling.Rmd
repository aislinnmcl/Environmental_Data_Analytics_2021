...
EPAair.summary.df %>% drop_na(month, year)
...
> Answer: `drop_na` simply drops rows containing missing values while `na.omit` assigns an attribute with class "omit". It's also faster when working with multiple inputs.
